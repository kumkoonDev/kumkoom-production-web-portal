<template>
  ...
  >
    ...
    <div class="flex items-end space-x-4 justify-end flex-1">
      <a href="https://www.facebook.com/kumkoonproductionhouse" target="_blank" rel="noopener noreferrer">
        <svg
      ...
      <a href="https://www.youtube.com/@KumkoonProduction-wd2tz" target="_blank" rel="noopener noreferrer">
        <svg
